...
$( document ).ready(function() {
    ...
    $(window).on('resize', function(){
        ...
        fromRight = (win.width() - $('.workContainer').width()) / 2;
        $('.work article.workPiece.current .workPieceContent .description').css('right', fromRight);
    ...
    //CHANGING TITLES TO FIXED POSITION ON SCROLL/////////////////
    ...
    $(document).scroll(function() {
       ...
       //LOOKING TO CHANGE WORKPIECE TITLE TO FIXED POSITIONING


       if(scroll_pos >= 0){
            fromRight = (win.width() - $('.workContainer').width()) / 2;
            $('.hands').addClass('current');
            $('.work article.workPiece.current .workPieceContent .description').css('right', fromRight);
